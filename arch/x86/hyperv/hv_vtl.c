...
static int __hv_vtl_enable_vcpu(struct hv_input_start_vp *input)
{
	u64 status;
	int ret = 0;
...
static void hv_vtl_populate_vp_context(struct hv_input_start_vp *input, u32 target_vp_index, int cpu)
{
